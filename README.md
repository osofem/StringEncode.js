...
INTRODUCTION
This library build on String.prototype to encode/decode strings to/from various bases. 
...
<script src="https://rawgit.com/osofem/StringEncode.js/master/StringEncode.js">
	//Encoding to ASCII85
